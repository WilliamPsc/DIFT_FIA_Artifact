...
parameter INTEGER_CHECK_S1      = 0; // 1 hc1
parameter INTEGER_CHECK_S2      = 1; // 2 hc2
parameter INTEGER_CHECK_D       = 2; // 3
// Branch class: BEQ, BNE, BLT[U], BGE[U]
parameter BRANCH_CHECK_S1       = 3; // 4 hc4
parameter BRANCH_CHECK_S2       = 4; // 5
// Jump class: JAL, JALR
parameter JUMP_CHECK_S1         = 5; // 6
parameter JUMP_CHECK_S2         = 6; // 7
parameter JUMP_CHECK_D          = 7; // 8 hc8
// Shift class: SLLI, SRLI, SRAI, SLL, SRL, SRA
parameter SHIFT_CHECK_S1        = 8; // 9
parameter SHIFT_CHECK_S2        = 9; // 10
parameter SHIFT_CHECK_D         = 10; // 11
// Comparison class: SLTI[U], SLT[U]
parameter COMPARISON_CHECK_S1   = 11; // 12
parameter COMPARISON_CHECK_S2   = 12; // 13
parameter COMPARISON_CHECK_D    = 13; // 14
// Logical class: ANDI, ORI, XORI, AND, OR, XOR
parameter LOGICAL_CHECK_S1      = 14; // 15
parameter LOGICAL_CHECK_S2      = 15; // 16 hc16
parameter LOGICAL_CHECK_D       = 16; // 17
// Load/Store class: LW, LH[U], LB[U], SW, SH, SB, LUI, AUIPC
parameter LOADSTORE_CHECK_S     = 17; // 18
parameter LOADSTORE_CHECK_SA    = 18; // 19
parameter LOADSTORE_CHECK_D     = 19; // 20
parameter LOADSTORE_CHECK_DA    = 20; // 21
// Execute class: PC
parameter EXECUTE_PC            = 21; // 22
