...
begin
  ...
  // -----------------------------------------------------------------------------------------
  riscv_hamming_code_encoder #(.REG_SIZE(1), .HC_SIZE(2)) hamming_code_encoder_rs1_o_tag (
    .clk          ( clk              ),
    .reg_i        ( rs1_o_tag_protec ),
    .hc_o         ( rs1_o_tag_hc     )
  );

  riscv_hamming_code_decoder #(.REG_SIZE(1), .HC_SIZE(2)) hamming_code_decoder_rs1_o_tag (
      .hc_i           ( rs1_o_tag_hc    ),
      .reg_i          ( rs1_o_tag       ),
