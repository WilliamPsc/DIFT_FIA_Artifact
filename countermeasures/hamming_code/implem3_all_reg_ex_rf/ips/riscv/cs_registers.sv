...
`endif
  ...
  `ifdef DIFT
    riscv_hamming_code_encoder #(.REG_SIZE(18), .HC_SIZE(5)) hamming_code_encoder_tpr (
      .clk    ( clk         ),
      .reg_i  ( tpr_n[17:0] ),
      .hc_o   ( tpr_hc      )
    );

    riscv_hamming_code_decoder #(.REG_SIZE(18), .HC_SIZE(5)) hamming_code_decoder_tpr (
      .reg_i          ( tpr_q[17:0]     ),
      .hc_i           ( tpr_hc          ),
    ...
    // ------------------------------------------------------------------------------------------
    riscv_hamming_code_encoder #(.REG_SIZE(22), .HC_SIZE(5)) hamming_code_encoder_tcr (
      .clk    ( clk         ),
      .reg_i  ( tcr_n[21:0] ),
      .hc_o   ( tcr_hc      )
    );

    riscv_hamming_code_decoder #(.REG_SIZE(22), .HC_SIZE(5)) hamming_code_decoder_tcr (
      .reg_i          ( tcr_q[21:0]     ),
      .hc_i           ( tcr_hc          ),
