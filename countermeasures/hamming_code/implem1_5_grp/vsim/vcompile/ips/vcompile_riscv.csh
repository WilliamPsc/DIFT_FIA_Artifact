...
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/hc_decoder_5.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/hc_decoder_26.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/hc_decoder_32.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/hc_decoder_rf_reg.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/hc_encoder_5.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/hc_encoder_26.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/hc_encoder_32.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/hc_encoder_rf_reg.sv || goto error
