...
`endif
  ...
  `ifdef DIFT
    riscv_hamming_code_encoder_32 hamming_code_encoder_tpr
    (
      .clk                     ( clk              ),
      .rst_n                   ( rst_n            ),
      .reg_i                   ( tpr_n            ),
    ...
    riscv_hamming_code_encoder_32 hamming_code_encoder_tcr
    (
      .clk                     ( clk              ),
      .rst_n                   ( rst_n            ),
      .reg_i                   ( tcr_n            ),
    ...
    riscv_hamming_code_decoder_32 hamming_code_decoder_tpr
    (
      .rst_n                   ( rst_n            ),
      .reg_i                   ( tpr_q            ),
      .hc_i                    ( tpr_hc_o         ),
      .sec_interrupt           ( sec_interrupt_0  ),
      .hc_o_corr               ( tpr_o_corr       )
    );

    riscv_hamming_code_decoder_32 hamming_code_decoder_tcr
    (
      .rst_n                   ( rst_n            ),
      .reg_i                   ( tcr_q            ),
      .hc_i                    ( tcr_hc_o         ),
      .sec_interrupt           ( sec_interrupt_1  ),
      .hc_o_corr               ( tcr_o_corr       )
    );
