...
`ifdef DIFT
  ...
  output logic        pc_if_o_tag_protec,
  output logic        pc_if_o_tag,
  output logic        pc_id_o_tag_protec,

  input  logic        pc_if_i_tag_corr
`endif
);
...
`ifdef DIFT
  ...
  begin
    if (if_valid_o)
    begin
      pc_id_o_tag_protec = pc_if_i_tag_corr;
    end
  end
