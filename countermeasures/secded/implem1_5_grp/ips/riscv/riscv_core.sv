...
`ifdef DIFT
  ...
  logic        pc_set_tag;
  logic        pc_id_tag;
  logic        pc_if_hc_protec;
  logic        pc_if_hc_o;
  logic        pc_if_tag_corr;
  logic        pc_id_hc_protec;
  logic        regfile_alu_wdata_fw_tag;
  logic        regfile_alu_we_fw_tag;
  logic        pc_enable_tag;
  logic        rs1_tag;
  logic        rs1_tag_protec;
  logic        exception_tag;
...
`ifdef DIFT
    ...
    .pc_if_o_tag_protec   ( pc_if_hc_protec    ),
    .pc_if_o_tag          ( pc_if_hc_o         ),
    .pc_id_o_tag          ( pc_id_tag          ),
    .pc_id_o_tag_protec   ( pc_id_hc_protec    ),

    .pc_if_i_tag_corr     ( pc_if_tag_corr     )
`endif
  );
...
`ifdef DIFT
    ...
    .pc_if_i_tag                  ( pc_if_hc_o               ),
    .pc_if_i_tag_protec           ( pc_if_hc_protec          ),
    .pc_id_i_tag_protec           ( pc_id_hc_protec          ),
    .pc_if_o_tag_corr             ( pc_if_tag_corr           ),
    .pc_enable_i_tag              ( pc_enable_tag            ),
    .rs1_i_tag                    ( rs1_tag                  ),
    .rs1_i_tag_protec             ( rs1_tag_protec           ),
    .exception_i_tag              ( exception_tag            ),
    .jump_target_o_tag            ( jump_target_id_tag       ),
    .pc_ex_o_tag                  (                          ),
    .pc_set_o_tag                 ( pc_set_tag               ),
    .alu_operator_o_mode_corr     ( alu_operator_mode        ),
    .store_dest_addr_ex_o_tag_corr( store_dest_addr_tag      ),
    .store_source_ex_o_tag_corr   ( store_source_tag         ),
    .use_store_ops_ex_o_corr      ( use_store_ops            ),
    .alu_operand_a_ex_o_tag_corr  ( alu_operand_a_tag        ),
    .alu_operand_b_ex_o_tag_corr  ( alu_operand_b_tag        ),
    .alu_operand_c_ex_o_tag_corr  ( alu_operand_c_tag        ),
    .check_s1_o_tag_corr          ( check_s1_tag             ),
    .check_s2_o_tag_corr          ( check_s2_tag             ),
    .check_d_o_tag_corr           ( check_d_tag              ),
    .register_set_o_tag_corr      ( register_set_tag         ),
    .is_store_post_o_tag_corr     ( is_store_post_tag        ),
    .memory_set_o_tag_corr        ( memory_set_tag           ),
    .regfile_alu_waddr_ex_o_tag_corr ( regfile_alu_waddr_tag    ),

    .data_we_q_i_tag_protec       ( data_we_q_tag_protec      ),
    .data_we_q_i_tag              ( data_we_q_tag             ),
    .data_we_q_o_tag_corr         ( data_we_q_tag_corr        ),

    .rdata_q_i_tag_protec         ( rdata_q_tag_protec        ),
    .rdata_q_i_tag                ( rdata_q_tag               ),
    .rdata_q_o_tag_corr           ( rdata_q_tag_corr          ),

    .rdata_offset_q_i_tag_protec  ( rdata_offset_q_tag_protec ),
    .rdata_offset_q_i_tag         ( rdata_offset_q_tag        ),
    .rdata_offset_q_o_tag_corr    ( rdata_offset_q_tag_corr   ),

    .data_type_q_i_tag_protec     ( data_type_q_tag_protec    ),
    .data_type_q_i_tag            ( data_type_q_tag           ),
    .data_type_q_o_tag_corr       ( data_type_q_tag_corr      )
`endif
  );
...
`ifdef DIFT
    ...
    .rs1_o_tag                  ( rs1_tag                      ),
    .rs1_o_tag_protec           ( rs1_tag_protec               ),
...
`ifdef DIFT
    ...
    .data_we_q_o_tag_protec       ( data_we_q_tag_protec      ),
    .data_we_q_o_tag              ( data_we_q_tag             ),
    .data_we_q_i_tag_corr         ( data_we_q_tag_corr        ),

    .rdata_q_o_tag_protec         ( rdata_q_tag_protec        ),
    .rdata_q_o_tag                ( rdata_q_tag               ),
    .rdata_q_i_tag_corr           ( rdata_q_tag_corr          ),

    .rdata_offset_q_o_tag_protec  ( rdata_offset_q_tag_protec ),
    .rdata_offset_q_o_tag         ( rdata_offset_q_tag        ),
    .rdata_offset_q_i_tag_corr    ( rdata_offset_q_tag_corr   ),

    .data_type_q_o_tag_protec     ( data_type_q_tag_protec    ),
    .data_type_q_o_tag            ( data_type_q_tag           ),
    .data_type_q_i_tag_corr       ( data_type_q_tag_corr      )
`endif
  );
