...
module riscv_register_file_tag #(
  ...
  riscv_secded_encoder_rf_reg #(.G_PARITY(G_PARITY)) secded_encoder_rf_tag (
    .clk          ( clk       ),
    .reg_i        ( rf_hc     ),
    .sd_o_rf_tag  ( rf_sd     ),
  ...
  riscv_secded_decoder_rf_reg #(.G_PARITY(G_PARITY)) secded_decoder_rf_tag (
    .reg_i          ( rf_reg        ),
    .hc_i           ( rf_reg_hc     ),
    .sd_i           ( rf_sd         ),
