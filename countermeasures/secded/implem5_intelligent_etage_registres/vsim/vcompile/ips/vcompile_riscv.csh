...
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/sd_encoder.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/sd_decoder.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/sd_encoder_rf_reg.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/sd_decoder_rf_reg.sv || goto error
