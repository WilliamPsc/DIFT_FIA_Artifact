...
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/sp_decoder_5.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/sp_decoder_26.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/sp_decoder_32.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/sp_decoder_rf_reg.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/sp_encoder_5.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/sp_encoder_26.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/sp_encoder_32.sv || goto error
vlog -quiet -sv -work ${LIB_PATH}   +incdir+${IP_PATH}/include ${IP_PATH}/sp_encoder_rf_reg.sv || goto error
