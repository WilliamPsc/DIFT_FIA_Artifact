...
`ifdef DIFT
  ...
  output logic error_o_csr_tpr,
  output logic [31:0] tcr_o,
  output logic error_o_csr_tcr,
`endif
...
`endif
  ...
  `ifdef DIFT
    riscv_simple_parity_encoder_32 simple_parity_encoder_tpr
    (
      .clk                     ( clk              ),
      .rst_n                   ( rst_n            ),
      .reg_i                   ( tpr_n            ),
    ...
    riscv_simple_parity_encoder_32 simple_parity_encoder_tcr
    (
      .clk                     ( clk              ),
      .rst_n                   ( rst_n            ),
      .reg_i                   ( tcr_n            ),
    ...
    riscv_simple_parity_decoder_32 simple_parity_decoder_tpr
    (
      .rst_n                   ( rst_n            ),
      .reg_i                   ( tpr_q            ),
      .sp_i                    ( tpr_sp           ),
      .error_o_csr             ( error_o_csr_tpr  )
    );

    riscv_simple_parity_decoder_32 simple_parity_decoder_tcr
    (
      .rst_n                   ( rst_n            ),
      .reg_i                   ( tcr_q            ),
      .sp_i                    ( tcr_sp           ),
      .error_o_csr             ( error_o_csr_tcr  )
    );
