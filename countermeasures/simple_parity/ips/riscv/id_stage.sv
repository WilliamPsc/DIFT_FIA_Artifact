...
`ifdef DIFT
    ...
    input  logic        error_i_csr_tpr,                   // From CSR
    input  logic [31:0] tcr_i,                             // From CSR
    input  logic        error_i_csr_tcr,                   // From CSR
...
`ifdef DIFT
  ...
  // Simple parity
  logic        error_addr_rf_tag;
  logic        error_i_rf_reg;
  logic        error_i_26;
`endif
  ...
  riscv_simple_parity_encoder_5 simple_parity_encoder_addr_rf_tag (
    .clk                 ( clk                          ),
    .rst_n               ( rst_n                        ),
    .reg_i               ( regfile_alu_waddr_id_protec  ),
    .sp_o_5              ( regfile_alu_waddr_id_sp      )
  );

  riscv_simple_parity_decoder_5 simple_parity_decoder_addr_rf_tag (
      .rst_n                ( rst_n                        ),
      .sp_i                 ( regfile_alu_waddr_id_sp      ),
      .reg_i                ( regfile_alu_waddr_ex_o_tag   ),
      .error_o_addr_rf_tag  ( error_addr_rf_tag            )
  );
...
`ifdef DIFT
    ...
    if (data_misaligned_i) begin
      ...
      begin
        ...
        begin
          ...
          use_store_ops_ex_o_protec   = use_store_ops_ex_o;
        end
  ...
  riscv_simple_parity_encoder_26 simple_parity_encoder_26
  (
    .clk                        (clk),
    .rst_n                      (rst_n),
    ...
    riscv_simple_parity_decoder_26 simple_parity_decoder_26
    (
      .rst_n                      (rst_n),
      .sp_i                       (sp_26),
      // INPUTS
...
`ifdef DIFT
  assign illegal_insn_dec_dift = illegal_insn_dec | exception_tag | exception_i_tag | (execute_pc_tag & pc_id_i_tag) | error_addr_rf_tag | error_i_csr_tcr | error_i_csr_tpr | error_i_rf_reg | error_i_26;
`else
